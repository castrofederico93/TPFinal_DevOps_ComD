...
INSERT INTO `asistencias` VALUES (1,'2025-09-19',1,1,'P'),(2,'2025-09-19',2,1,'A'),(3,'2025-09-19',3,1,'P'),(4,'2025-09-19',4,1,'T'),(5,'2025-09-18',1,2,'P'),(6,'2025-09-18',2,2,'P'),(7,'2025-09-18',5,2,'J'),(8,'2025-09-18',6,2,'A'),(9,'2025-09-17',3,3,'P'),(10,'2025-09-17',4,3,'P'),(11,'2025-09-19',5,4,'P'),(12,'2025-09-19',6,4,'P'),(13,'2025-09-19',10,4,'A'),(14,'2025-09-16',7,5,'P'),(15,'2025-09-16',8,5,'P'),(16,'2025-09-16',9,5,'T');
...
CREATE TABLE `comisiones` (
  ...
  `estado` enum('Inscripción','En curso','Finalizado') NOT NULL DEFAULT 'Inscripción',
...
INSERT INTO `comisiones` VALUES (1,'MAT-1_A',1,1,'A','Lunes 19hs','En curso',20,'Central','A confirmar'),(2,'PROG-1_B',2,2,'B','Miércoles 18hs','En curso',30,'Central','A confirmar'),(3,'BD-1_C',3,1,'C','Jueves 20hs','En curso',25,'Central','A confirmar'),(4,'MAT-1_B',1,1,'B','Martes 18hs','En curso',25,'Central','A confirmar'),(5,'PROG-1_A',2,2,'A','Lunes 20hs','En curso',30,'Central','A confirmar'),(6,'BD-1_A',3,3,'A','Viernes 19hs','En curso',25,'Central','A confirmar');
...
INSERT INTO `materias` VALUES (1,'MAT-1','Matemáticas'),(2,'PROG-1','Introducción a Programación'),(3,'BD-1','Base de Datos');
...
INSERT INTO `usuarios` VALUES (1,'alumno1','$2a$10$MDZbW8eIrGdC96.3kw5YXOZa3crzpq/sRlbetTE4YfAu9Jdp/k4oa',1),(2,'docente2','$2a$10$KKeSEg/1JCzgyYMXs9auQOcuvyk5SKJYOMTvK2qNVjA7UErwNHmrW',2),(3,'administrativo3','$2a$10$7kL8dvcKvqTzbrtfmXwRNeNXw0kK/UtL.Fn932NLszqHsqNVnieQK',3),(4,'preceptor4','$2a$10$jxYAG6YHtPJ7YkJi7KbHF.mjItce/xem6lt5p4EZ/tNGTFV6e2dbq',4);
...
-- Dump completed on 2025-11-12 18:25:25
